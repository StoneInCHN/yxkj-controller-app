 ...
 * RecyclerView 分隔线
 */
public class SuperDividerUtil extends RecyclerView.ItemDecoration {
    ...
    private SuperDividerUtil(@DrawableRes int drawableResId) {
     ...
     * @return
     */
    public static SuperDividerUtil newDrawableDivider(@DrawableRes int drawableResId) {
        return new SuperDividerUtil(drawableResId);
    }
     ...
     * @return
     */
    public static SuperDividerUtil newShapeDivider(int resId) {
        return new SuperDividerUtil(resId);
    }
     ...
     * @return
     */
    public static SuperDividerUtil newBitmapDivider() {
//        return new SuperDividerUtil(R.mipmap.bga_adapter_divider_bitmap);
        return null;
    }
     ...
     * @return
     */
    public SuperDividerUtil setBothMarginDp(int bothMarginDp) {
     ...
     * @return
     */
    public SuperDividerUtil setMarginLeftDp(int marginLeftDp) {
     ...
     * @return
     */
    public SuperDividerUtil setMarginRightDp(int marginRightDp) {
     ...
     * @return
     */
    public SuperDividerUtil setColor(@ColorRes int resId) {
     ...
     * @return
     */
    private SuperDividerUtil setColorResource(@ColorInt int color) {
     ...
     * @return
     */
    public SuperDividerUtil setHorizontal() {
     ...
     * @return
     */
    public SuperDividerUtil rotateDivider() {
     ...
     * @return
     */
    public SuperDividerUtil setStartSkipCount(@IntRange(from = 0) int startSkipCount) {
     ...
     * @return
     */
    public SuperDividerUtil setEndSkipCount(@IntRange(from = 0) int endSkipCount) {
     ...
     * @return
     */
    public SuperDividerUtil setSizeDp(int sizeDp) {
